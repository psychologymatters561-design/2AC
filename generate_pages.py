...
def get_header(path_prefix=''):
    return f"""
  <header>
    <div class="logo">
      <a href="{path_prefix}index.html" style="font-family: 'Playfair Display', serif; font-size: 1.5rem; font-weight: bold; color: var(--gold-accent);">Air Control</a>
    </div>
    <nav class="nav-links">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          <a href="{path_prefix}ac-repair.html">AC Repair</a>
          <a href="{path_prefix}ac-servicing.html">AC Servicing</a>
          <a href="{path_prefix}ac-installation.html">AC Installation</a>
          <a href="{path_prefix}ac-amc.html">AC AMC</a>
        </div>
      </div>
      <div class="dropdown">
        <a href="#">Areas ▾</a>
        <div class="dropdown-content">
          <a href="{path_prefix}ac-service-delhi.html">Delhi</a>
          <a href="{path_prefix}ac-service-gurgaon.html">Gurgaon</a>
          <a href="{path_prefix}ac-service-noida.html">Noida</a>
          <a href="{path_prefix}ac-service-faridabad.html">Faridabad</a>
          <a href="{path_prefix}ac-service-ghaziabad.html">Ghaziabad</a>
        </div>
      </div>
  ...
  <footer id="contact">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        <h3>Services</h3>
        <ul>
          <li><a href="{path_prefix}ac-repair.html">AC Repair</a></li>
          <li><a href="{path_prefix}ac-servicing.html">AC Servicing</a></li>
          <li><a href="{path_prefix}ac-installation.html">AC Installation</a></li>
          <li><a href="{path_prefix}ac-amc.html">AC AMC</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h3>Service Areas</h3>
        <ul>
          <li><a href="{path_prefix}ac-service-delhi.html">Delhi</a></li>
          <li><a href="{path_prefix}ac-service-gurgaon.html">Gurgaon</a></li>
          <li><a href="{path_prefix}ac-service-noida.html">Noida</a></li>
          <li><a href="{path_prefix}ac-service-faridabad.html">Faridabad</a></li>
          <li><a href="{path_prefix}ac-service-ghaziabad.html">Ghaziabad</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h3>Quick Links</h3>
...
def generate_page(filename, title, desc, h1, keywords, content, path_prefix=''):
    html = f"""<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  {get_header(path_prefix)}
  
  <main>
    {content}
  </main>
  
  {get_footer(path_prefix)}
...
for loc in locations:
    generate_page(
        loc['file'],
        f"AC Repair & Service in {loc['name']} | Air Control Since 1987",
        f"Expert AC repair, servicing, and installation in {loc['name']}. Fast response, genuine parts, and 38 years of experience.",
        f"AC Repair, Service & Installation in {loc['name']}",
        f"AC repair {loc['name']}, AC service {loc['name']}, AC installation {loc['name']}",
        f"""
    <div class="breadcrumbs">
